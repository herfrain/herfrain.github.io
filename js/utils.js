  ...
  registerSidebarTOC: function() {
    ...
    const sections = [...navItems].map(element => {
      ...
      link.addEventListener('click', event => {
        event.preventDefault();
        var target = document.getElementById(decodeURI(event.currentTarget.getAttribute('href').replace('#', ''))); // 适配中文
      ...
      return document.getElementById(decodeURI(link.getAttribute('href').replace('#', ''))); // 适配中文
    });
